...
![Auto-approve toolbar collapsed state](../../assets/img/auto-approving-actions/auto-approving-actions.png)
...
![Auto-approve toolbar expanded state](../../assets/img/auto-approving-actions/auto-approving-actions-1.png)
_Expanded toolbar with all options_
...
![Master toggle in Auto-approve toolbar](../../assets/img/auto-approving-actions/auto-approving-actions-14.png)
_Master toggle controls all auto-approve permissions at once_
...
1. Click gear icon in the top-right corner
2. Navigate to Auto-Approve Settings

![Settings panel auto-approve options](../../assets/img/auto-approving-actions/auto-approving-actions-4.png)
...
![Read-only operations setting](../../assets/img/auto-approving-actions/auto-approving-actions-6.png)
_Read operations settings_
...
![Write operations setting with delay slider](../../assets/img/auto-approving-actions/auto-approving-actions-7.png)
_Write operations settings with diagnostic delay slider_
...
**Description:** When enabled, Kilo Code can overwrite or modify files that are normally protected by the [`.kilocodeignore`](../../customize/custom-rules.md) file.
...
![Browser actions setting](../../assets/img/auto-approving-actions/auto-approving-actions-8.png)
_Browser actions settings_
...
![API requests retry setting with delay slider](../../assets/img/auto-approving-actions/auto-approving-actions-9.png)
_API request retry settings_
...
![MCP tools setting](../../assets/img/auto-approving-actions/auto-approving-actions-10.png)
_MCP tools auto-approval settings_
...
![Mode switching setting](../../assets/img/auto-approving-actions/auto-approving-actions-11.png)
_Mode switching settings_
...
![Subtasks setting](../../assets/img/auto-approving-actions/auto-approving-actions-12.png)
_Subtasks auto-approval settings_
...
![Command execution setting with whitelist interface](../../assets/img/auto-approving-actions/auto-approving-actions-13.png)
_Command execution settings with allowlist and denylist_
