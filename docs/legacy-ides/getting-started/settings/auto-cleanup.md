...
1. Click the gear icon (gear icon) in Kilo Code
2. Navigate to the **Auto-Cleanup** section (under Checkpoints)

### Enable Auto-Cleanup

![Auto-Cleanup settings panel](../../assets/img/auto-cleanup/settings.png)
_Auto-Cleanup settings panel_
...
Tasks successfully completed via the [`attempt_completion`](../../automate/tools/attempt-completion.md) tool are retained for this period. These tasks typically represent finished work that may still be useful for reference.
...
- [**Checkpoints**](../../code-with-ai/features/checkpoints.md): Version control for tasks that can be restored
- [**Settings Management**](../settings.md): Export/import settings including cleanup configuration
- [**Task History**](../../code-with-ai/agents/chat-interface.md): Managing and organizing your task history
