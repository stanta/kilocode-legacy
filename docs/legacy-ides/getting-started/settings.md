...
You can find these options at the bottom of the Kilo Code settings page, accessible via the gear icon (gear icon) in the Kilo Code chat view.

![Export, Import, and Reset buttons in Kilo Code settings](../assets/img/settings-management/settings-management.png)
_Export, Import, and Reset buttons_
...
Learn more about [Custom Modes](../customize/custom-modes.md) and how Power Steering can improve mode behavior.
