...
The plugin runs the Kilo extension host with Node.js 20.6.0 or newer. It checks for a bundled runtime first and falls back to a compatible Node.js installation on your `PATH`.
...
_Image unavailable: Step-by-step guide showing how to enable JCEF in Android Studio._
...
See the [legacy IDE documentation](../../README.md) for the rest of the manual.
