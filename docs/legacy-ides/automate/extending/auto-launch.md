...
- **`profile`** (string): Name of an existing [API Configuration Profile](../../ai-providers/README.md) to use for this task. Must exactly match a profile name from your settings.
...
- **`mode`** (string): The Kilo Code mode to use for this task. Available modes:
    ...
    - Custom mode slugs (if you have [custom modes](../../customize/custom-modes.md))
...
3. Check that the profile exists in your [API Configuration Profiles](../../ai-providers/README.md)
