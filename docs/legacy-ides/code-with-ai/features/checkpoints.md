...
1. Open Settings by clicking the gear icon gear icon → Checkpoints
2. Check or uncheck the "Enable automatic checkpoints" checkbox

![Checkpoint settings in Kilo Code configuration](../../assets/img/checkpoints/checkpoints.png)
...
- **Initial checkpoint** marks your starting project state
  ![Initial checkpoint indicator in chat](../../assets/img/checkpoints/checkpoints-1.png)

- **Regular checkpoints** appear after file modifications or command execution
  ![Regular checkpoint indicator in chat](../../assets/img/checkpoints/checkpoints-2.png)
...
![View Differences button interface](../../assets/img/checkpoints/checkpoints-6.png)
...
![View differences option for checkpoints](../../assets/img/checkpoints/checkpoints-3.png)
...
2. Click the checkpoint's `Restore Checkpoint` button
   ![Restore checkpoint button interface](../../assets/img/checkpoints/checkpoints-7.png)
3. Choose one of these restoration options:

![Restore checkpoint option](../../assets/img/checkpoints/checkpoints-4.png)
...
![Confirmation dialog for restoring checkpoint with files & task](../../assets/img/checkpoints/checkpoints-9.png)
