...
![Generated commit message example](../../assets/img/git-commit-generation/git-commit-1.png)
...
1. Open Settings by clicking the gear icon gear icon → `Prompts`
2. Find the "Commit Message Generation" section
3. Edit the `Prompt` template to match your project's conventions

![Commit message generation settings](../../assets/img/git-commit-generation/git-commit-2.png)
...
> **Tip:**
> Consider creating a dedicated [API configuration profile](../../ai-providers/README.md) with a faster, more cost-effective model specifically for commit message generation.
...
- [API Configuration Profiles](../../ai-providers/README.md) - Use different models for commit generation
- [Settings Management](../../getting-started/settings.md) - Manage all your Kilo Code preferences
