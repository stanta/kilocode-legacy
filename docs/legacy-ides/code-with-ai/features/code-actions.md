...
> **Info:**
> Code Actions are available through the editor integration.
...
![VS Code code actions in line with code](../../assets/img/code-actions/code-actions-1.png)
...
![code actions - add to context gif](../../assets/img/code-actions/add-to-context.gif)
...
1.  **Open the Prompts Tab:** Click the notebook icon icon in the Kilo Code top menu bar.
