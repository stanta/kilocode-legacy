...
![Context Mentions Overview - showing the @ symbol dropdown menu in the chat interface](../../assets/img/context-mentions/context-mentions.png)
_Context mentions overview showing the @ symbol dropdown menu in the chat interface._

## Types of Mentions

![File mention example showing a file being referenced with @ and its contents appearing in the conversation](../../assets/img/context-mentions/context-mentions-1.png)
...
![Folder mention example showing directory contents being referenced in the chat](../../assets/img/context-mentions/context-mentions-2.png)
...
![Problems mention example showing VS Code problems panel being referenced with @problems](../../assets/img/context-mentions/context-mentions-3.png)
...
![Terminal mention example showing terminal output being included in Kilo Code's context](../../assets/img/context-mentions/context-mentions-4.png)
...
![Git commit mention example showing commit details being analyzed by Kilo Code](../../assets/img/context-mentions/context-mentions-5.png)
...
![URL mention example showing website content being converted to Markdown in the chat](../../assets/img/context-mentions/context-mentions-6.png)
