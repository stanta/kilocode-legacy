...
- [Custom Instructions](custom-instructions.md) - Global instructions vs. skill-based instructions
- [Custom Rules](custom-rules.md) - Project-level rules complementing skills
