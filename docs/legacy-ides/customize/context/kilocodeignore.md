...
- [`read_file`](../../automate/tools/read-file.md)
- [`write_to_file`](../../automate/tools/write-to-file.md)
- [`apply_diff`](../../automate/tools/apply-diff.md)
- [`delete_file`](../../automate/tools/delete-file.md)
- [`execute_command`](../../automate/tools/execute-command.md)
- [`list_files`](../../automate/tools/list-files.md)
...
Checkpoint tracking is separate from file access rules. Files blocked by `.kilocodeignore` or permission rules can still be checkpointed if they are not excluded by `.gitignore`. See the [Checkpoints](../../code-with-ai/features/checkpoints.md) documentation for details.
