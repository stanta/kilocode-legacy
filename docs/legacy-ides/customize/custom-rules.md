...
Kilo Code provides a built-in interface for managing your custom rules without manually editing files in the `.kilocode/rules/` directories. To access the UI, click on the law icon icon in the **bottom right corner** of the Kilo Code window.
...
![Rules tab in Kilo Code](../assets/img/custom-rules/rules-ui.png)
...
![Kilo Code ignores request to read sensitive file](../assets/img/custom-rules/custom-rules.png)
