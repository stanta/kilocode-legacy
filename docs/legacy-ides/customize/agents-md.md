...
| ------------------------------------------------- | ------- | ------------------------- | ----------------------------------------- | ----------- |
| **[Mode-specific Custom Rules](custom-rules.md)** | Project | `.kilocode/rules-{mode}/` | Mode-specific rules and constraints       | 1 (Highest) |
| **[Custom Rules](custom-rules.md)**               | Project | `.kilocode/rules/`        | Kilo Code-specific rules and constraints  | 2           |
| **[AGENTS.md](agents-md.md)**                     | Project | `AGENTS.md`               | Universal standard for any AI coding tool | 3           |
| **[Global Custom Rules](custom-rules.md)**        | Global  | `~/.kilocode/rules/`      | Global Kilo Code rules                    | 4           |
| **[Custom Instructions](custom-instructions.md)** | Global  | IDE settings              | Personal preferences across all projects  | 5 (Lowest)  |
...
- **[Custom Rules](custom-rules.md)** - Kilo Code-specific rules with more control
- **[Custom Modes](custom-modes.md)** - Specialized workflows with specific permissions
- **[Custom Instructions](custom-instructions.md)** - Personal preferences across all projects
- **[Migrating from Cursor or Windsurf](https://kilo.ai/docs/getting-started/migrating)** - Migration guide for other tools
