...
- **Codebase Indexing:** The `gemini-embedding-001` model is specifically supported for [codebase indexing](../customize/context/codebase-indexing.md), providing high-quality embeddings for semantic code search.
