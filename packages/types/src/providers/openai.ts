...
export const openAiNativeModels = {
	...
	"gpt-5.6-sol": {
		...
		description: "GPT-5.6 Sol: OpenAI's frontier model for complex professional work",
	},
	"gpt-5.6-terra": {
		maxTokens: 128000,
		contextWindow: 1_050_000,
		...
		supportsTemperature: false,
		tiers: [
			{ name: "flex", contextWindow: 1_050_000, inputPrice: 1.0, outputPrice: 6.0, cacheReadsPrice: 0.1 },
			{ name: "priority", contextWindow: 1_050_000, inputPrice: 4.0, outputPrice: 24.0, cacheReadsPrice: 0.4 },
		],
		description: "GPT-5.6 Terra: GPT-5.6 model that balances intelligence and cost",
	},
	"gpt-5.6-luna": {
		maxTokens: 128000,
		contextWindow: 1_050_000,
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		tiers: [{ name: "flex", contextWindow: 1_050_000, inputPrice: 0.1, outputPrice: 0.6, cacheReadsPrice: 0.01 }],
		description: "GPT-5.6 Luna: GPT-5.6 model optimized for cost-sensitive workloads",
	},
	// kilocode_change end
	"gpt-5.1-codex-max": {
		maxTokens: 128000,
