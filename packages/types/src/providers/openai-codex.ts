...
export const openAiCodexModels = {
	...
	"gpt-5.6-sol": {
		...
		description: "GPT-5.6 Sol: Frontier GPT-5.6 model for complex professional work via ChatGPT subscription",
	},
	"gpt-5.6-terra": {
		maxTokens: 128000,
		contextWindow: 1_050_000,
		...
		outputPrice: 0,
		supportsTemperature: false,
		description: "GPT-5.6 Terra: Balanced GPT-5.6 model for intelligence and cost via ChatGPT subscription",
	},
	"gpt-5.6-luna": {
		maxTokens: 128000,
		contextWindow: 1_050_000,
		...
		outputPrice: 0,
		supportsTemperature: false,
		description: "GPT-5.6 Luna: Cost-efficient GPT-5.6 model for high-volume workloads via ChatGPT subscription",
	},
	// kilocode_change end
	"gpt-5.5": {
		maxTokens: 128000,
